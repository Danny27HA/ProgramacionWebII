function generarQR(){
    ...
    let textocontatenado= input1 +","+input2+","+input3+","+input4;

    if(textocontatenado===",,,"){
        alert("Los datos estan vacios");
    }

    var qrCodeURL = 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=' + encodeURIComponent(textocontatenado);
